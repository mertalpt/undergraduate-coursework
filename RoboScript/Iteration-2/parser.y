...
%%
start: program {printf("Input program is correct.\n");}
...
non_when: while_loop | for_loop | assignment | func_call | var_declaration;
...
assign_op  : ASSIGN_OP | INC_BY | DEC_BY | MULT_BY | DIV_BY;
crement_op : INC | DEC;
